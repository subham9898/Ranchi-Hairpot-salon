...
const SERVICES = [
  ...
  },
  {
    ...
    title: 'Body Massage',
    hindi: 'बॉडी मसाज',
    description: 'Relaxing therapeutic massages to de-stress your mind and body.',
    time: '60 min',
  ...
  },
  {
    ...
    title: 'Hair Coloring',
    hindi: 'हेयर कलरिंग',
    description: 'Professional hair coloring and global highlights.',
    time: '2-3 hours',
    icon: <Sparkles className="w-6 h-6" />,
  },
  {
...
const REVIEWS = [
  {
    name: 'Gaurav Kumar',
    text: 'Good service and great hair stylists at Upper Bazar',
    rating: 5,
  },
  {
    name: 'Ashish Kumar',
    text: 'Very good at Upper Bazar...good service, hair cut is also done quite well',
    rating: 5,
  },
  {
    name: 'Priya Singh',
    text: 'Good behaviour and good environment. Best parlour in Ranchi.',
    rating: 4,
  },
];
    ...
    <div className="min-h-screen selection:bg-primary/30">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled ? 'bg-white/80 backdrop-blur-md shadow-sm py-4' : 'bg-transparent py-8'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex flex-col group cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <span className={`text-2xl md:text-3xl font-serif font-bold tracking-tighter transition-colors duration-500 ${scrolled ? 'text-secondary' : 'text-white'}`}>
              Ranchi Hairport
            </span>
            <div className="flex items-center space-x-2">
              <div className={`h-[1px] transition-all duration-500 bg-primary ${scrolled ? 'w-full' : 'w-0 group-hover:w-full'}`}></div>
              <span className={`text-[9px] uppercase tracking-[0.4em] font-bold ${scrolled ? 'text-primary' : 'text-primary'}`}>
                Family Salon
              </span>
            </div>
          </div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 z-10 text-center">
          ...
          >
            <span className="section-subtitle !text-white/80 mb-6 block">Lalji Hirji Rd • Ranchi</span>
            <h1 className="text-5xl md:text-8xl lg:text-9xl font-serif text-white leading-[0.9] mb-8">
              The Art of <br />
              <span className="gold-text-gradient italic">Pure Beauty</span>
            </h1>
            <p className="text-white/70 text-lg md:text-xl max-w-2xl mx-auto mb-12 font-light tracking-wide leading-relaxed">
              Experience award-winning excellence in wellness. 
              Where luxury meets tradition in the heart of Upper Bazar.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <a href="tel:06203883859" className="text-white text-sm font-bold uppercase tracking-[0.2em] flex items-center hover:text-primary transition-colors group">
            ...
            <div className="lg:w-2/5 p-12 lg:p-20 bg-white/5 flex flex-col justify-center">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 text-white/80">
                  ...
                  <span className="text-sm font-medium">062038 83859</span>
                </div>
                <div className="flex items-center space-x-4 text-white/80">
                  <div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center">
                    <MapPin className="w-4 h-4 text-primary" />
                  </div>
                  <span className="text-sm font-medium">Lalji Hirji Rd, Upper Bazar, Ranchi</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="relative">
              ...
              <p className="text-gray-500 text-lg mb-12 leading-relaxed">
                Nestled in the heart of Upper Bazar, our salon offers a peaceful retreat from the bustling city life. 
                Experience luxury that's conveniently located.
              </p>
              ...
              <div className="mt-16 flex flex-wrap gap-6">
                <a href="https://www.google.com/maps" target="_blank" className="btn-luxury">Get Directions</a>
                <a href="https://wa.me/916203883859" className="flex items-center text-sm font-bold uppercase tracking-widest text-secondary hover:text-primary transition-colors">
            ...
            <div className="h-[600px] rounded-[40px] overflow-hidden shadow-2xl grayscale hover:grayscale-0 transition-all duration-1000">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3662.656096501306!2d85.3204369750913!3d23.36442007893522!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4e100085db383%3A0x67343e0d86e927f8!2sRanchi%20Hairport%20Family%20Salon!5e0!3m2!1sen!2sin!4v1711956000000!5m2!1sen!2sin" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                allowFullScreen 
      ...
      <footer className="bg-secondary text-white pt-32 pb-12">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-20 mb-32">
            <div className="space-y-8">
              <div className="flex flex-col">
                <span className="text-4xl font-serif font-bold tracking-tighter">Ranchi Hairport</span>
                <span className="text-[10px] uppercase tracking-[0.5em] font-bold text-primary">Family Salon</span>
              </div>
              <p className="text-white/40 text-sm leading-relaxed">
                We have been the benchmark of beauty in Ranchi. 
          ...
          <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 text-[10px] uppercase tracking-[0.2em] text-white/20">
            <p>© 2026 Ranchi Hairport. Crafted for Excellence.</p>
      ...
      <div className="fixed bottom-10 right-10 z-50 hidden md:block">
        <a href="https://wa.me/916203883859" className="luxury-glass p-4 rounded-full flex items-center space-x-4 group hover:bg-white/20 transition-all">
          ...
          <div className="pr-4">
            ...
            <div className="text-sm font-serif text-white">Chat with us</div>
          </div>
        </a>
      </div>
    </div>
